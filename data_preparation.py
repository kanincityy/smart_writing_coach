...
# Load your full dataset CSV (use raw string or double backslashes for Windows paths)
...
# Split dataset into train (72%), validation (8%), test (20%) using stratification
...
print(f"Train size: {len(train_df)}") # Output=4666
print(f"Validation size: {len(val_df)}") # Output=519
print(f"Test size: {len(test_df)}") #Output=1297

# Visualize distribution of overall proficiency scores in the train set
