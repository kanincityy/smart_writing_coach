...
class FeedbackGenerator:
    ...
    def generate_feedback(self, essay_text: str, rubric_scores: dict, teacher:str) -> str:
        ...
        """
        system_prompt, user_prompt = self._construct_prompt(essay_text, rubric_scores, teacher)
        
        print("Generating feedback with Gemini 3 Flash...", file=sys.stderr)
        try:
            response = self.client.models.generate_content(
                model="gemini-3-flash-preview", 
                contents=[system_prompt, user_prompt], config=types.GenerateContentConfig(temperature=0.6, 
